				...
				<div class="space-y-12 md:text-left">
					<div class="mb-20 space-y-5 sm:mx-auto sm:max-w-xl md:max-w-2xl sm:space-y-4 lg:max-w-5xl">
						...
						<p class="text-xl text-gray-500">
							These are the amazing individuals who help to make us the top in our game. Are you interested in working with us? Check out our available position at our
							<a href="#_" class="font-medium text-blue-500 underline">career page</a>.
						</p>
					</div>
					<div class="mx-auto space-y-16 sm:grid sm:grid-cols-2 sm:gap-16 sm:space-y-0 lg:grid-cols-3 lg:max-w-5xl">
						<div class="space-y-6 text-center lg:ml-0 md:ml-10">
							<div class="relative w-48 h-48 p-2 mx-auto md:w-56 md:h-56">
								...
								<svg class="absolute inset-0 w-full h-full text-pink-500 transform scale-150 fill-current opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
									<path
						...
						<div class="space-y-6 text-center lg:mr-0 md:mr-10">
							<div class="relative w-48 h-48 p-2 mx-auto md:w-56 md:h-56">
								...
								<svg class="absolute inset-0 w-full h-full mt-2 text-green-500 transform scale-150 fill-current opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
									<path
						...
						<div class="space-y-6 text-center lg:ml-0 md:ml-10">
							<div class="relative w-48 h-48 p-2 mx-auto md:w-56 md:h-56">
								...
								<svg class="absolute inset-0 w-full h-full text-yellow-500 transform scale-150 fill-current opacity-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
									<path
